...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="container-lg justify-center mt-10">
                    @if($posts->isEmpty())
                        No posts! Log in and create your own!
                    @else
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-row justify-content-between">
                                            <div class="btns">
                                                ...
                                                <a href="{{ route('post.edit', ['post' => $post->id]) }}" class="btn-sm btn-warning">Edit</a>
                                                <a href="{{ route('post.delete', ['post' => $post->id]) }}" class="btn-sm btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        @if (!Auth::guest() && $post->user_id != Auth::user()->id)
                                            <div class="rating d-inline-flex">
                                                <div class="thumb-up">
                                                    <a href="{{ route('post.up', ['post' => $post->id]) }}">
                                                        @if ($post->ratingValues->first()?->value && !$post->ratingValues->isEmpty())
                                                ...
                                                <div class="thumb-down">
                                                    <a href="{{ route('post.down', ['post' => $post->id]) }}">
                                                        @if (!$post->ratingValues->first()?->value && !$post->ratingValues->isEmpty())
